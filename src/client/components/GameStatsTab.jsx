    ...
    <section className="m-2 h-1/2 flex-grow">
      <div>
        <span className="flex items-center">
          <button onClick={() => copyToClipboard('CODE', gameCode)} className="flex items-center" type="button">
            <span>
              {`GAME CODE: ${gameCode}`}
            </span>
            {copiedField === 'CODE' ? (
        ...
        {gamePassword && (
          <span className="flex items-center">
            <button onClick={() => copyToClipboard('PASSWORD', gamePassword)} className="flex items-center" type="button">
              <span>
