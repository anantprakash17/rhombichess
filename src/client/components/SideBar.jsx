...
export default function SideBar({ session }) {
  ...
  return (
    <>
      <button onClick={() => { setOpenSidebar(!openSidebar); }} data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" hidden={openSidebar} className="absolute top-0 h-fit items-start p-2 mt-4 ml-3 text-sm rounded-lg sm:hidden focus:outline-none focus:ring-2 text-gray-800 hover:bg-gray-700 focus:ring-gray-600 focus:text-white z-50">
