    ...
    <section className="w-full flex h-screen">
      <div className="flex flex-1">
        <div className="scale-90 flex-grow">
          <Board local={gameData.local} initialTurn={gameData.turn} initialColor={color} initialBoard={gameData.board} gameCode={gameCode} socket={socket} initialValidMoves={gameData.valid_moves} />
        </div>
