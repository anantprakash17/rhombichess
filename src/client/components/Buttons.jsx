...
export function SendMessageButton({ onClick }) {
  return (
    <button className="flex items-center bg-blue-500 mb- p-[0.7rem] rounded-md focus:ring-blue-300 outline-none focus:ring-2" type="button" aria-label="Send Message" onClick={onClick}>
