    ...
    <section className="bg-whitebg-gray-900">
      <div className="py-8 px-8 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="max-w-screen-md mb-8 lg:mb-16">
          ...
          White moves first. Players must checkmate the opposing King to win. When a White Pawn or Soldier reaches row 30 or beyond, or a Black Pawn or Soldier reaches row 8 or beyond, it must be promoted to any piece except those or a King.
          </p>
        </div>
        <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
                <Image src="/images/shield-wht.png" alt="soldier" width={300} height={200} />
            </div>
            ...
            <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
                <Image src="/images/pawn-wht.png" alt="pawn2" width={300} height={200} />
            </div>
            ...
            <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
                <Image src="/images/soldier-wht.png" alt="soldier2" width={300} height={200} />
            </div>
