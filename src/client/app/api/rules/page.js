        ...
        <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                <Image src="/images/rook-wht.png" alt="rook" width={300} height={200} />
            </div>
            <h3 className="mb-2 text-xl font-bold dark:text-white">Rook</h3>
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">Machine</h3>
            <p className="text-gray-500 dark:text-gray-400">
          ...
          <div>
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">Bishop</h3>
            <p className="text-gray-500 dark:text-gray-400">
          ...
          <div>
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">Elephant</h3>
            <p className="text-gray-500 dark:text-gray-400">
          ...
          <div>
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">Jester</h3>
            <p className="text-gray-500 dark:text-gray-400">
          ...
          <div>
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">Dog</h3>
            <p className="text-gray-500 dark:text-gray-400">
          ...
          <div>
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">Queen</h3>
            <p className="text-gray-500 dark:text-gray-400">
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">Mammoth</h3>
            <p className="text-gray-500 dark:text-gray-400">
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">Cat</h3>
            <p className="text-gray-500 dark:text-gray-400">
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">Hawk</h3>
            <p className="text-gray-500 dark:text-gray-400">
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">Soldier</h3>
            <p className="text-gray-500 dark:text-gray-400">
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">Knight</h3>
            <p className="text-gray-500 dark:text-gray-400">
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">King</h3>
            <p className="text-gray-500 dark:text-gray-400">
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">Prince</h3>
            <p className="text-gray-500 dark:text-gray-400">
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">Pawn 1</h3>
            <p className="text-gray-500 dark:text-gray-400">
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">Pawn 2</h3>
            <p className="text-gray-500 dark:text-gray-400">
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">Soldier 1</h3>
            <p className="text-gray-500 dark:text-gray-400">
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">Soldier 2</h3>
            <p className="text-gray-500 dark:text-gray-400">
