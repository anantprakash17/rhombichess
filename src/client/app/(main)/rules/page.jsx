      ...
      <div className="py-8 px-8 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
              <Image src="/pieces/rook-white.png" alt="rook" width={300} height={200} className="mx-auto" />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
              <Image src="/pieces/bishop-white.png" alt="bishop" width={300} height={200} />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
              <Image src="/pieces/elephant-white.png" alt="elphant" width={300} height={200} />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
              <Image src="/pieces/jester-white.png" alt="jester" width={300} height={200} />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
              <Image src="/pieces/dog-white.png" alt="dog" width={300} height={200} />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
              <Image src="/pieces/queen-white.png" alt="queen" width={300} height={200} />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
              <Image src="/pieces/mammoth-white.png" alt="mammoth" width={300} height={200} />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
              <Image src="/pieces/cat-white.png" alt="cat" width={300} height={200} />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
              <Image src="/pieces/hawk-white.png" alt="hawk" width={300} height={200} />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
              <Image src="/pieces/shield-white.png" alt="soldier" width={300} height={200} />
            </div>
            <h3 className="mb-2 text-xl font-bold text-gray-900">Shield</h3>
            <p className="text-gray-500">
          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
              <Image src="/pieces/knight-white.png" alt="knight" width={300} height={200} />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
              <Image src="/pieces/king-white.png" alt="king" width={300} height={200} />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
              <Image src="/pieces/prince-white.png" alt="prince" width={300} height={200} />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
              <Image src="/pieces/pawn-white.png" alt="pawn1" width={300} height={200} />
            </div>
            <h3 className="mb-2 text-xl font-bold text-gray-900">Pawn Type-1</h3>
            <p className="text-gray-500">
          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
              <Image src="/pieces/pawn-white.png" alt="pawn2" width={300} height={200} />
            </div>
            <h3 className="mb-2 text-xl font-bold text-gray-900">Pawn Type-2</h3>
            <p className="text-gray-500">
          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
              <Image src="/pieces/soldier-white.png" alt="soldier1" width={300} height={200} />
            </div>
            <h3 className="mb-2 text-xl font-bold text-gray-900">Soldier Type-1</h3>
            <p className="text-gray-500">
          ...
          <div className="flex flex-col items-center">
            <div className="flex justify-center items-center mb-4 w-12 h-12 rounded-full lg:h-15 lg:w-15 bg-gray-800">
              <Image src="/pieces/soldier-white.png" alt="soldier2" width={300} height={200} />
            </div>
            <h3 className="mb-2 text-xl font-bold text-gray-900">Soldier Type-2</h3>
            <p className="text-gray-500">
